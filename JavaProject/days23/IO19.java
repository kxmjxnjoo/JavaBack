...
//사칙연산의 결과를 저장할 수 있는 CalculatorResult 클래스를 작성
//CaluculaterResult 클래스는 연산에 사용된 좌항,우항의 정보, 연산자 부호, 
//연산의 결과 저장할 수 있는 멤버변수들이 있음
//CaluculatorResult클래스는 toString메소드를 통해서 연산식과 결과를 출력할 수 있음
...
//		CalculatorResult cr = new CalculatorResult(20, 30,"x", 6000.0);
//		System.out.println(cr);
		...
		Date now = c.getTime(); //얻은 날짜를 Date형으로 변환	
