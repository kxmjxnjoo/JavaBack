...
class JComboBoxTest extends JFrame implements ItemListener{
	...
	JComboBoxTest(){
		...
		//콤보상자는 목록으로 들어갈 데이터가 정해지지 않은 상태로 서로 다른 자료형도 
		//입력 가능하지만 실제 사용시점에서 목록으로 사용할 데이터 형식을 결정함
		//- (String, double, int등 객체도 사용가능)
		// <>에 자료형을 넣어 현재 사용할 콤보상자 목록의 데이터 형식을 결정함
	...
	public void itemStateChanged(ItemEvent e) {
		...
		jl.setIcon(ni); //라벨에 setIcon으로 이미지 아이콘을 교체함
	}
}
