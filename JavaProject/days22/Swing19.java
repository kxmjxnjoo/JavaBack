...
class Resume extends JFrame implements ActionListener{
	...
	Resume(){
		...
		lb1.setFont(f);		lb2.setFont(f);
		lb3.setFont(f);		lb4.setFont(f);
		lb5.setFont(f);
		jp1.add(lb1); 		jp1.add(lb2); 
		jp1.add(lb3); 		jp1.add(lb4); 
		jp1.add(lb5); 
		...
		jcb.addItem("010"); jcb.addItem("02"); jcb.addItem("032"); 
		jcb.addItem("031");
		jcb.setFont(f);
		...
		jcb2.addItem("서울"); jcb2.addItem("경기도"); 
		jcb2.addItem("강원도"); jcb2.addItem("충청도"); 
		jcb2.addItem("경상도"); jcb2.addItem("전라도");
		jcb2.addItem("제주도");
		jcb2.setFont(f);		jp25.add(jcb2);		jp2.add(jp25);
		
		JButton jb = new JButton("확인");
		jb.setFont(f);		jp26.add(jb);		jp2.add(jp26);
