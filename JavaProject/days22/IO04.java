...
//	- 일반적으로 문자 스트림은 문자 스트림 클래스의 객체를 생성하여 입력을 수행함
//	- 기존에 생성된 바이트 스트림이 존재한다면, 바이트 스트림의 객체를 사용하여 문자 스트림으로 변환할 수 있음
//	- 바이트 스트림 객체를 문자 스트림으로 변환하는 방법
//	- InputStreamReader클래스를 사용
//	    - 바이트 스트림의 객체를 생성자의 매개변수로 전달받아 해당 바이트 스트림을 문자 스트림으로 변환
		InputStreamReader reader = new InputStreamReader(System.in);
		//byte형 입력만 가능한 System.in(입력받는 기능)을 InputStreamReader가 장착하고
		//char형 입력이 가능하게 확장된 read()메소드를 사용함
