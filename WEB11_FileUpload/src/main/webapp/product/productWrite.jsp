...
<h1>상품 등록 - 관리자 페이지</h1>
<form method="post" enctype="multpart/form-data" action="product.do?command=productWrite">
<table>
	<tr><th>상 품 명</th><td><input type="text" name="name" size="80"></td></tr>
		...
		<tr><th>설 명</th><td><textarea cols="80" rows="10" name="description"></textarea></td>
	</tr>
</table><br>
